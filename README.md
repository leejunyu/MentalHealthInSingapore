...
The project consists of the following three main objectives: (RQ1) How has the general mood of Singaporeans varied over the last 10 years (2010-2020) and what are the key factors affecting it? (RQ) 2Examining the impact of Covid-19 on emotion state in Singapore in 2020 and (RQ3) Comparing and understanding the overall sentiment of Singapore and other countries due to Covid-19. 
